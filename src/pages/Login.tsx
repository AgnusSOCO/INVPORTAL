...
import { BarChart3, Loader2, Lock, Mail, Shield } from 'lucide-react';
        ...
        <div className="w-full max-w-md mx-auto relative z-10">
          <Card className={isDark 
            ...
            <CardHeader className="space-y-1 text-center pb-6">
              ...
              <CardTitle className={`text-2xl font-bold ${isDark ? "text-white" : "text-gray-900"}`}>Investor Portal</CardTitle>
            ...
            <CardFooter className={`flex flex-col space-y-4 border-t ${isDark 
              ...
              <div className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"} pt-2`}>
                ...
                <Link to="/register" className="text-emerald-600 underline-offset-4 hover:underline">
                  Register
                </Link>
              </div>
            </CardFooter>
